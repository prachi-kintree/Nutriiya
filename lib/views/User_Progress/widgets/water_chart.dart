...
class WaterChart extends StatefulWidget {
  ...
  WaterChart({super.key, required this.currentTab});
          ...
          Row(
            children: [
              Container(
                ...
                width: 8.h,
                decoration: BoxDecoration(
                    shape: BoxShape.circle, color: Color(0xff1A96F0)),
              ),
              5.sBW,
              Text("Selected",
                  style: AppTextStyle.outfitStyle(
          ...
          SizedBox(
            ...
            child: selectedFormat == 1
              ...
              onMarkerRender: (MarkerRenderArgs args) {
                ...
                if (point.isSelected) {
                  args.color = const Color(0xff1A96F0); // green fill
                  args.borderColor = const Color(0xff1A96F0);
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border.all(
                              color: Color(0xff1A96F0), width: 3),
              ...
              series: <CartesianSeries<CalorieData, String>>[
                ...
                AreaSeries<CalorieData, String>(
                  ...
                  borderColor: const Color(0xff1A96F0),
                  borderWidth: 4,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color(0xff1A96F0), width: 5)
          ),
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(color: const Color(0xff1A96F0), fontWeight: FontWeight.bold, fontSize: 12),
              ),
              Text(
                'mL',
                style: TextStyle(color: const Color(0xff1A96F0), fontSize: 10),
              ),
            ],
          ),
        ),

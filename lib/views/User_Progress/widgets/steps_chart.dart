...
class StepsChart extends StatefulWidget {
  ...
  StepsChart({super.key, required this.currentTab});
  @override
          ...
          Row(
            children: [
              ...
              CustomPaint(
                ...
                painter: DashedLinePainter(color: Color(0xffFF981F)),
              ),
              8.sBW,
              Text(
                'Step Goal',
          ...
          SizedBox(
            ...
            child: selectedFormat == 1
              ...
              onMarkerRender: (MarkerRenderArgs args) {
                ...
                if (point.isSelected) {
                  args.color = const Color(0xffFF981F); // green fill
                  args.borderColor = const Color(0xffFF981F);
                    ...
                    children: [
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: Colors.white,
                          border: Border.all(
                              color: Color(0xffFF981F), width: 3),
              ...
              series: <CartesianSeries<CalorieData, String>>[
                ...
                AreaSeries<CalorieData, String>(
                  ...
                  borderColor: const Color(0xffFF981F),
                  borderWidth: 4,
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: const Color(0xffFF981F), width: 5)
          ),
          child: Column(
            ...
            children: [
              Text(
                ...
                style: TextStyle(color: const Color(0xffFF981F), fontWeight: FontWeight.bold, fontSize: 12),
              ),
              Text(
                'steps',
                style: TextStyle(color: const Color(0xffFF981F), fontSize: 10),
              ),
            ],
          ),
        ),

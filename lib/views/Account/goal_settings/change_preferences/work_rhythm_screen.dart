...
class _DietaryPreferencesState extends State<WorkRhythmScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian, type: " 9-to-5", isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian, type: "Shift work", isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian, type: "Night shifts", isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian, type: "Flexible hours", isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian, type: "Something else", isSelected: false),
  ];
  @override

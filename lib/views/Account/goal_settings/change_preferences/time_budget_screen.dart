...
class _DietaryPreferencesState extends State<TimeBudgetScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian, dietType: "5 min", isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian, dietType: "10 min", isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian, dietType: "15 min", isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian, dietType: "30 min", isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        dietType: "I’ll use it as needed",
        isSelected: false),
  ];
  @override

...
class StayOnTrackScreen extends StatefulWidget {
  const StayOnTrackScreen({
    super.key,
  });

  @override
  State<StayOnTrackScreen> createState() => _DietaryPreferencesState();
}

class _DietaryPreferencesState extends State<StayOnTrackScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        dietType: "Set Realistic Goals",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        dietType: "Track Progress Easily",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        dietType: "Move More, Stress Less",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        dietType: "Celebrate Small Wins",
        isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        dietType: "Your Language. Your Food.",
        isSelected: false),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(
        appBarTitle: "Stay on Track with Confidence",
      ),
      body: Container(
        height: 1.sh,

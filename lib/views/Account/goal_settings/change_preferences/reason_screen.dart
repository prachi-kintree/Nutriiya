...
class RealReasonScreen extends StatefulWidget {
  const RealReasonScreen({
    super.key,
  });

  @override
  State<RealReasonScreen> createState() => _DietaryPreferencesState();
}

class _DietaryPreferencesState extends State<RealReasonScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian, dietType: "To feel healthier", isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        dietType: "To feel more confident",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        dietType: "To have more energy",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        dietType: "To reach a personal goal",
        isSelected: false),
    SelectableFieldItem(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(
        ...
        appBarTitle: "What’s your real reason \nfor this journey?",
      ),
      body: Container(
        height: 1.sh,

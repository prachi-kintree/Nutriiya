...
class _DietaryPreferencesState extends State<BuildStreakScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian, type: "3 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian, type: "7 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian, type: "14 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian, type: "30 Days", isSelected: false),
  ];
  @override

...
class BuildStreakScreen extends StatefulWidget {
  const BuildStreakScreen({
    super.key,
  });

  @override
  State<BuildStreakScreen> createState() => _DietaryPreferencesState();
}

class _DietaryPreferencesState extends State<BuildStreakScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian, dietType: "3 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian, dietType: "7 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian, dietType: "14 Days", isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian, dietType: "30 Days", isSelected: false),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(
        appBarTitle: "Ready to Build a Streak?",
      ),
      body: Container(
        height: 1.sh,

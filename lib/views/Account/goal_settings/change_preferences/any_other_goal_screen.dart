...
class AnyOtherGoalScreen extends StatefulWidget {
  const AnyOtherGoalScreen({
    super.key,
  });

  @override
  State<AnyOtherGoalScreen> createState() => _DietaryPreferencesState();
}

class _DietaryPreferencesState extends State<AnyOtherGoalScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        dietType: "Build a routine that sticks",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        dietType: "Feel happier and less stressed",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        dietType: "Sleep better at night",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        dietType: "Get stronger and more toned",
        isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        dietType: "Be the best version of myself",
        isSelected: false),
    SelectableFieldItem(
        icon: svgMessage, dietType: "None of the above", isSelected: false),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(
        appBarTitle: "Do you have any other goals?",
      ),
      body: Container(
        height: 1.sh,

...
class _DietaryPreferencesState extends State<AnyOtherGoalScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        type: "Build a routine that sticks",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        type: "Feel happier and less stressed",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        type: "Sleep better at night",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        type: "Get stronger and more toned",
        isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        type: "Be the best version of myself",
        isSelected: false),
    SelectableFieldItem(
        icon: svgMessage, type: "None of the above", isSelected: false),
  ];
  @override

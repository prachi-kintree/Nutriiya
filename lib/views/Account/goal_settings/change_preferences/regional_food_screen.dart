...
class RegionalFoodScreen extends StatefulWidget {
  const RegionalFoodScreen({
    super.key,
  });

  @override
  State<RegionalFoodScreen> createState() => _DietaryPreferencesState();
}

class _DietaryPreferencesState extends State<RegionalFoodScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    ...
    SelectableFieldItem(
        icon: svgCentralIndian, dietType: "Central Indian", isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian, dietType: "West Indian", isSelected: false),
  ];
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: const CommonAppBar(
        appBarTitle: "Regional Food Preferences",
      ),
      body: Container(
        height: 1.sh,

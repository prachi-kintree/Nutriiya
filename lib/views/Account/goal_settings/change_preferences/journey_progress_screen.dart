...
class _DietaryPreferencesState extends State<JourneyProgressScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        dietType: "Just getting started",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        dietType: "Tried a few times before",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        dietType: "Lost weight in the past",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        dietType: "Already on the journey",
        isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian, dietType: "Never tried before", isSelected: false),
  ];
  @override

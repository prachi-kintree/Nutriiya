...
class _DietaryPreferencesState extends State<BigWinsScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        type: " Celebrate with friends",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian,
        type: "Enjoy a favorite healthy meal",
        isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian, type: "Buy something nice", isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian, type: "Treat yourself", isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        type: "Choose your own way",
        isSelected: false),
  ];
  @override

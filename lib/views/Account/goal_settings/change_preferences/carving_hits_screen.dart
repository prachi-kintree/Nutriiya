...
class _DietaryPreferencesState extends State<CarvingHitsScreen> {
  List<SelectableFieldItem> regionalFoodPrefs = [
    SelectableFieldItem(
        icon: svgNorthIndian,
        dietType: "Boredom or low mood",
        isSelected: false),
    SelectableFieldItem(
        icon: svgSouthIndian, dietType: "Stress or anxiety", isSelected: false),
    SelectableFieldItem(
        icon: svgEastIndian,
        dietType: "Scrolling or watching TV",
        isSelected: false),
    SelectableFieldItem(
        icon: svgCentralIndian,
        dietType: "Looks or smells too good",
        isSelected: false),
    SelectableFieldItem(
        icon: svgWestIndian,
        dietType: "Something else? We’ll find out.",
        isSelected: false),
  ];
  @override

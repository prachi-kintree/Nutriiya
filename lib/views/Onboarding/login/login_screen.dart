...
class LoginScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const Scaffold(
      ...
      body: SafeArea(
        child: Stack(
          children: [CustomGradientBackground(), Login()],
        ),
      ),
    );
  }
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              _loginMethods(icon: svgGoogleIcon,context: context, title: "Google", onTap: () {}),
              _loginMethods(icon: svgAppleIcon,context: context, title: "Apple", onTap: () {}),
              _loginMethods(icon: svgPersonIcon,context: context, title: "Guest", onTap: () {}),
            ],
          ),
          40.sBH,
          RichText(
